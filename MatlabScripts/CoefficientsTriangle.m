...
Re100_table = PlotCoefficient(TriangleRe100_50, window, fig1, Re100_table, 2, 'r', 0, 'Re100_50');
exportgraphics(gcf, ['LatexFigures/TriangleDrag100.pdf'], 'ContentType', 'vector', 'Resolution', 300);

fig2 = figure; hold on;
Re100_table = PlotCoefficient(TriangleRe100_25, window, fig2, Re100_table, 1, 'b', 1, 'Re100_25');
Re100_table = PlotCoefficient(TriangleRe100_50, window, fig2, Re100_table, 2, 'r', 1, 'Re100_50');
exportgraphics(gcf, ['LatexFigures/TriangleLift100.pdf'], 'ContentType', 'vector', 'Resolution', 300);

fig3 = figure; hold on;
Re1000_table = PlotCoefficient(TriangleRe1000_25, window, fig3, Re1000_table, 1, 'b', 0, 'Re1000_25');
Re1000_table = PlotCoefficient(TriangleRe1000_50, window, fig3, Re1000_table, 2, 'r', 0, 'Re1000_50');
exportgraphics(gcf, ['LatexFigures/TriangleDrag1000.pdf'], 'ContentType', 'vector', 'Resolution', 300);

fig4 = figure; hold on;
Re1000_table = PlotCoefficient(TriangleRe1000_25, window, fig4, Re1000_table, 1, 'b', 1, 'Re1000_25');
Re1000_table = PlotCoefficient(TriangleRe1000_50, window, fig4, Re1000_table, 2, 'r', 1, 'Re1000_50');
...
Re100_table_paper = [1.88 0.085 0.217 * 2 0.217 * 2 0.0 0.464 0.217 0.217;
                     1.92 0.070 0.218 * 2 0.218 * 2 0.0 0.471 0.218 0.218];
...
Re1000_table_paper = [3.05 0.455 0.191 * 2 0.191 * 2 0.0 0.721 0.191 0.191;
                      3.05 0.455 0.191 * 2 0.191 * 2 0.0 0.721 0.191 0.191];
...
function [mean_value, amplitude, frequencies] = AverageInTimeWindow(signal, t, window)
    ...
    lastidx = min(min(length(maxvalues), length(minvalues)), 10);
