...
for k = 1:length(steps)
    ...
    tc_10_2 = ParticleData(['../CSV_Data/' dirname '/TaylorCouette_new_differential_constV_10_10_1rf_1prc/file'], nfile, ['10x2'], rho0, dim, Hconst);
    ...
    tc_20_2 = ParticleData(['../CSV_Data/' dirname '/TaylorCouette_new_differential_constV_20_20_1rf_1prc/file'], nfile, ['20x2'], rho0, dim, Hconst);
    ...
    tc_30_2 = ParticleData(['../CSV_Data/' dirname '/TaylorCouette_new_differential_constV_30_30_1rf_1prc/file'], nfile, ['30x2'], rho0, dim, Hconst);
    ...
    tc_40_2 = ParticleData(['../CSV_Data/' dirname '/TaylorCouette_new_differential_constV_40_40_1rf_1prc/file'], nfile, ['40x2'], rho0, dim, Hconst);
    ...
    tc_50_2 = ParticleData(['../CSV_Data/' dirname '/TaylorCouette_new_differential_constV_50_50_1rf_1prc/file'], nfile, ['50x2'], rho0, dim, Hconst);
...
y2 = log10(E_2_avg(1)) + (2) * (x_range - log10(hsize(1))) + offset_2;

figure; hold on;
% plot(log10(hsize), log10(E_1_avg), 'ro-');
plot(log10(hsize), log10(E_2_avg), 'ro-');
% plot(log10(hsize), log10(E_05_avg), '-o');
% plot(log10(hsize), log10(E_sum_avg), '-o');
plot(log10(hsize), log10(E_old_avg), 'bo-');
...
exportgraphics(gcf, 'LatexFigures/TaylorCouetteOrder.pdf', 'ContentType', 'vector', 'Resolution', 300);

txt = {['slope new x2 = ' num2str(p2(1))]; [' slope old = ' num2str(pold(1))]};
txt
